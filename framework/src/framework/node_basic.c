...
TBmakeStmts (node * Stmt, node * Next)
{
  ...
  if ((STMTS_STMT (this) != NULL)
      ...
      && (NODE_TYPE (STMTS_STMT (this)) != N_do))
    {
...
#ifndef DBUG_OFF
  DBUG_PRINT ("MAKE", ("doing son target checks"));
  if ((DO_BLOCK (this) != NULL) && (NODE_TYPE (DO_BLOCK (this)) != N_while))
    {
      CTIwarn ("Field Block of node N_Do has non-allowed target node.");
    }
#endif /* DBUG_OFF */
  DBUG_RETURN (this);
}
...
node *
TBmakeWhile (char *While, node * Expr)
{
  node *this;
  ...
  WHILE_WHILE (this) = While;
#ifndef DBUG_OFF
  DBUG_PRINT ("MAKE", ("doing son target checks"));
  if ((WHILE_EXPR (this) != NULL)
      && (NODE_TYPE (WHILE_EXPR (this)) != N_assign)
      && (NODE_TYPE (WHILE_EXPR (this)) != N_do))
    {
