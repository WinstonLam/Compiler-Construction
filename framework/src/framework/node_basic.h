...
#define DO_BLOCK( n) ((n)->sons.N_do->Block)
extern node *TBmakeDo (node * Block);
...
#define WHILE_WHILE( n) ((n)->attribs.N_while->While)
extern node *TBmakeWhile (char *While, node * Expr);
