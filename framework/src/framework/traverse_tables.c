...
travtables_t travtables = {
  ...
  /* TR_prt */
  , {&TRAVerror, &PRTstmts, &PRTassign, &PRTdo, &PRTwhile, &PRTbinop,
     &PRTvarlet, &PRTvar, &PRTnum, &PRTfloat, &PRTbool, &PRTsymboltableentry,
     &PRTerror}

  /* TR_copy */
  , {&TRAVerror, &COPYstmts, &COPYassign, &COPYdo, &COPYwhile, &COPYbinop,
     &COPYvarlet, &COPYvar, &COPYnum, &COPYfloat, &COPYbool,
     &COPYsymboltableentry, &COPYerror}

  /* TR_free */
  , {&TRAVerror, &FREEstmts, &FREEassign, &FREEdo, &FREEwhile, &FREEbinop,
     &FREEvarlet, &FREEvar, &FREEnum, &FREEfloat, &FREEbool,
     &FREEsymboltableentry, &FREEerror}

  /* TR_chk */
  , {&TRAVerror, &CHKstmts, &CHKassign, &CHKdo, &CHKwhile, &CHKbinop,
     &CHKvarlet, &CHKvar, &CHKnum, &CHKfloat, &CHKbool, &CHKsymboltableentry,
     &CHKerror}
  ...
  /* TR_si */
  , {&TRAVerror, &TRAVsons, &TRAVsons, &TRAVsons, &TRAVsons, &TRAVsons,
     &TRAVsons, &TRAVsons, &SInum, &TRAVsons, &TRAVsons, &TRAVsons, &TRAVsons}

  /* TR_os */
  , {&TRAVerror, &TRAVsons, &TRAVsons, &TRAVsons, &TRAVsons, &OSbinop,
     &TRAVsons, &TRAVsons, &TRAVsons, &TRAVsons, &TRAVsons, &TRAVsons,
     &TRAVsons}

  /* TR_sr */
  , {&TRAVerror, &TRAVsons, &TRAVsons, &TRAVsons, &TRAVsons, &SRbinop,
     &TRAVsons, &TRAVsons, &TRAVsons, &TRAVsons, &TRAVsons, &TRAVsons,
     &TRAVsons}
};
...
const char *travnames[9] = {
  "unknown", "prt", "copy", "free", "chk", "ri", "si", "os", "sr"
};
